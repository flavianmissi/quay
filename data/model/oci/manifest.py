...
def create_manifest(
    repository_id: int, manifest: ManifestInterface | ManifestListInterface
) -> Manifest:
    """
    ...
    """
    # TODO: how to handle validation? it's currently at the manifest type level.
...
def connect_manifests(manifests: list[Manifest], parent: Manifest, repository_id: int):
    ...
    Raises a _ManifestAlreadyExists if any of the manifests already exist.
    """
    children = [
